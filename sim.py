...
class PyBulletSim:
    ...
    def __init__(self, use_random_objects=False, object_shapes=None, gui=True):
        ...
        self.robot_body_id = p.loadURDF(
            "D:/bihuijin/graspGripper-main/assets/ur5/ur5.urdf", [0, 0, 0.4], p.getQuaternionFromEuler([0, 0, 0]))
        self._mount_body_id = p.loadURDF(
            "D:/bihuijin/graspGripper-main/assets/ur5/mount.urdf", [0, 0, 0.2], p.getQuaternionFromEuler([0, 0, 0]))
        ...
        self._tote1_body_id = p.loadURDF(
            "D:/bihuijin/graspGripper-main/assets/tote/toteA_large.urdf", self._tote1_position, p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=True)
        ...
        self._tote2_body_id = p.loadURDF(
            "D:/bihuijin/graspGripper-main/assets/tote/toteA_large.urdf", self._tote2_position, p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=True)
        ...
        if object_shapes is not None:
            ...
            self._object_shapes = [
                "D:/bihuijin/graspGripper-main/assets/objects/cube.urdf",
                "D:/bihuijin/graspGripper-main/assets/objects/rod.urdf",
                "D:/bihuijin/graspGripper-main/assets/objects/custom.urdf",
            ]
        ...
        # Add obstacles
        self.obstacles = [
            p.loadURDF('D:/bihuijin/graspGripper-main/assets/obstacles/block.urdf',
    ...
    def load_gripper(self):
        ...
        self._gripper_body_id = p.loadURDF("D:/bihuijin/graspGripper-main/assets/gripper/robotiq_2f_85.urdf")
