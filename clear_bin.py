...
if __name__ == "__main__":
    ...
    object_meshes = [
        "D:/bihuijin/graspGripper-main/assets/objects/cube.obj",
        "D:/bihuijin/graspGripper-main/assets/objects/rod.obj",
        "D:/bihuijin/graspGripper-main/assets/objects/custom.obj",
    ]
    ...
    model.to(device)
    model, _, _ = train_seg_model.load_chkpt(model, 'D:/bihuijin/graspGripper-main/checkpoint.pth.tar', device)
    model.eval()
